    ...
    <div class="wrap">
        <div class="card">
                    ...
                    <asp:TemplateField HeaderText="">
                        <ItemTemplate>
                            <asp:HyperLink runat="server" CssClass="btn"
                                NavigateUrl='<%# ResolveUrl("~/User/MemberTransactionLogs.aspx")
            ...
            <div style="margin-top: 16px">
                <asp:HyperLink ID="hlBack" runat="server" CssClass="btn" Text="Back to group" />
            </div>
        </div>
    </div>
</asp:Content>
