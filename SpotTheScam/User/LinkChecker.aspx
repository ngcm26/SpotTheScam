<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="LinkChecker.aspx.cs" Inherits="SpotTheScam.User.LinkChecker" Async="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        * {
        ...
        .checker-input {
            width: 100%;
            min-height: 48px; /* Shorter input for URL */
            max-width: 600px;
            border-radius: 12px;
        ...
        /* Bottom section styling (copied from ScamChecker) */
        .why-scam-section {
            background: #f6f8fa;
            width: 100%;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="checker-main-bg">
        ...
        <div class="checker-tabs">
            ...
            <button type="button" class="checker-tab" onclick="window.location.href='/User/ScamChecker.aspx'">
                <span class="tab-icon">
        ...
        <div class="checker-card">
            <div class="checker-title">Is this link safe?</div>
            <div class="checker-desc">Detect if a URL has a phishing link or is malicious.</div>
            <div class="input-section">
                <asp:TextBox ID="txtUrlInput" runat="server" CssClass="checker-input" placeholder="Enter your URL here" />
                <div style="display: flex; gap: 12px; justify-content: center; align-items: center; margin-top: 8px;">
                    <asp:Button ID="btnCheckLink" runat="server" Text="Analyze" OnClick="btnCheckLink_Click" CssClass="checker-analyze-btn" />
    ...
    <!-- Why Use Link Checker Section -->
    <div class="why-scam-section">
        <div class="why-scam-container">
            <h2 class="why-scam-title">What does a Link Checker do?</h2>
            <div class="why-scam-desc">Link Checker is a tool designed to help you detect scams, phishing attacks, and fake or malicious websites.</div>
            <div class="why-scam-content" style="margin-top: 40px;">
                <div class="why-scam-illustration">
                    <img src="/Images/person.svg" alt="Link Checker Illustration" />
                </div>
                <div class="why-scam-features">
                    <div class="why-scam-feature">
                        <div class="why-scam-feature-title">Avoid phishing attacks</div>
                        <div class="why-scam-feature-desc">Got a suspicious link? Check it before clicking — it will significantly reduce the chances of you falling for a phishing attack.</div>
                    </div>
                    <div class="why-scam-feature">
                        <div class="why-scam-feature-title">Block malicious websites</div>
                        <div class="why-scam-feature-desc">Some websites are ridden with malware that waits to be downloaded and executed on your device. Link Checker will let you know about it before it’s too late.</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function clearCheckerInputs() {
            var txt = document.getElementById('<%= txtUrlInput.ClientID %>');
            if (txt) txt.value = '';
            var box = document.getElementById('resultSection');
