<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="SpotTheScam.User.ForgotPassword" MasterPageFile="User.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        /* Primary action button styled to match Verify page */
    ...
    <div class="verify-container">
        <div class="verify-card">
            ...
            <div class="d-grid gap-2">
                <asp:Button ID="btnSend" runat="server" Text="Send reset link" CssClass="btn btn-login" OnClick="btnSend_Click" />
