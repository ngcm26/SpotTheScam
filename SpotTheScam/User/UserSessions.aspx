<%@ Page Title="Webinar Sessions" Language="C#" MasterPageFile="User.Master" AutoEventWireup="true" CodeBehind="WebinarSessions.aspx.cs" Inherits="SpotTheScam.User.WebinarSessions" %>
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <button class="filter-btn active">All Sessions</button>
                            <button class="filter-btn inactive">Free Only</button>
                            <button class="filter-btn inactive">Premium</button>
                        </div>
                    </div>
                    <div class="row align-items-center mt-2">
                        ...
                        <div class="col-auto">
                            <select class="topic-dropdown">
                                ...
                                <option>Banking Security</option>
                                <option>Phone Scams</option>
