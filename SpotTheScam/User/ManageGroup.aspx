        ...
        <main class="family-content">
            <div class="wrap">
                ...
                <div class="card">
                    ...
                    <!-- Invite existing user by email (UI will be hidden for non-owners via code-behind) -->
                ...
                <div class="card">
                    ...
                    <asp:GridView ID="gvMembers" runat="server" AutoGenerateColumns="false" CssClass="table"
                        EmptyDataText="No members yet. Use &quot;Send Invite&quot; to add one."
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Role">
                                <ItemTemplate>
                                    <span class='tag role-<%# Eval("GroupRole") %>'><%# Eval("GroupRole") %></span>
                            ...
                            <asp:TemplateField HeaderText="Status">
                                <ItemTemplate>
                                    <span class='pill status-<%# Eval("Status") %>'><%# Eval("Status") %></span>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Actions">
                                <ItemTemplate>
                                    <span class="inline-actions">
                                        <asp:HyperLink ID="hlView" runat="server" Text="View Accounts" CssClass="btn-link" />
                                        <asp:LinkButton ID="lnkRestrict" runat="server" CommandName="Restrict"
                                            CommandArgument='<%# Eval("UserId") %>' Text="Set Restrictions" CssClass="btn-link" />
